...
window.TRIP = (function () {
  ...
  const DAYS = {
    ...
    '5-23': { legId: 'istanbul', title: 'Istanbul, two continents',
      ...
      picks: [
        { cat: 'Music', name: 'Megadeth + Kaptan Kadavra', note: 'KüçükÇiftlik Park, doors 21:00 — the big metal night; buy ahead', link: 'https://www.bubilet.com.tr/istanbul/etkinlik/megadeth/seans/187231' },
        { cat: 'Music', name: 'Sami Yusuf at Harbiye Açıkhava', note: 'World / sufi music in the open-air amphitheatre; also plays Jun 24', link: 'https://www.bubilet.com.tr/istanbul/etkinlik/sami-yusuf/seans/242668' },
        { cat: 'Nightlife', name: 'Kadıköy — Kadife Sokak + Arkaoda', note: 'Where young locals drink; indie DJ sets, far less touristy than Beyoğlu' },
        { cat: 'History', name: 'Şerefiye (Theodosius) Cistern', note: 'The Byzantine cistern locals visit instead of the mobbed Basilica one', link: 'https://www.serefiyesarnici.istanbul/' },
        { cat: 'Stay', name: 'Karaköy or Balat', note: 'Karaköy for nightlife and ferries; Balat for bohemian backstreets' },
      ] },
    '5-24': { legId: 'aegean', title: 'South to Çanakkale',
      ...
      notes: 'Bozcaada is iconic but a genuine detour (ferry plus its own overnight), and your dates fall in its quiet between-events lull — skip it unless you add a night.',
      picks: [
        { cat: 'History', name: 'Troya Müzesi en route', note: 'Excellent 2018 museum near Tevfikiye; go late afternoon to dodge tour buses', link: 'https://muze.gov.tr/muze-detay?DistId=TRO&SectionId=TRO01' },
        { cat: 'Music', name: 'ÇARİM percussion concert', note: 'Free, Belediye Kültür Merkezi, 20:30 — confirmed for this night', link: 'https://www.canakkale.bel.tr/tr/sayfa/1140-haberler/11452-haziran-ayi-kultur-sanat-etkinlikleri' },
        { cat: 'Nightlife', name: 'Fetvane Sokak + Han Bar', note: 'Car-free bar street; Han Bar in an Ottoman han is the rock / alt student heart' },
        { cat: 'Food', name: 'Yalova Restaurant', note: 'Since 1940, around 70 mezes — the local institution; skip the Kordon tourist menus', link: 'https://yalovarestoran.com/' },
        { cat: 'Stay', name: 'Hotel Kervansaray', note: '1903 konak on Fetvane Sokak; ask for a courtyard-facing room (street noise)' },
      ] },
    '5-25': { legId: 'aegean', title: 'Mount Ida',
      ...
      picks: [
        { cat: 'Hike', name: 'Sütüven Şelalesi + Hasanboğuldu', note: 'Easy forest walk in Kazdağı Milli Parkı; self-drive via Zeytinli, go early', link: 'https://www.idanatura.com/hasanboguldu-sutuven-yuruyusu' },
        { cat: 'Stop', name: 'Adatepe village + Zeus Altarı', note: 'Stone village, a gulf-view altar and Turkey’s first olive-oil museum — right on the road south' },
        { cat: 'Food', name: 'Lal Girit Mutfağı, Cunda', note: 'Cretan home cooking and papalina (the in-season Gulf sardine); local-loved value', link: 'https://eksisozluk.com/lal-girit-mutfagi--4877788' },
        { cat: 'Nightlife', name: 'Moshos / Muhabbet Sokak', note: 'Moshos for live rebetiko (touristy but real); Ayvalık’s Muhabbet Sokak for bars. Check CunDeli prices first' },
        { cat: 'View', name: 'Şeytan Sofrası sunset', note: 'Go for the panorama only — the coin-throwing “footprint” is a tourist gimmick locals mock' },
        { cat: 'Stay', name: 'Adatepe / Yeşilyurt taş evler', note: 'Optional: Manici Kasrı or Orion Adatepe stone houses if you would trade nightlife for atmosphere' },
      ] },
    '5-26': { legId: 'izmir', title: 'Cunda → Sığacık',
      ...
      notes: 'Sığacık’s famous producer market runs Sunday only — see Jun 28 for how to catch it on the way out.',
      picks: [
        { cat: 'Beach', name: 'Patriça Koyu / Bıyıklı Beach', note: 'Morning swim in a protected, clear cove; Bıyıklı draws the young crowd, Badavut is quietest' },
        { cat: 'Food', name: 'Ayvalık tostu + serpme kahvaltı', note: 'Tostçular Çarşısı (Mesut / Avşar) for the toast; Zeytinlik for an Aegean breakfast' },
        { cat: 'Stop', name: 'Sığacık Kaleiçi + Teos', note: 'Inhabited Ottoman-fortress old town; the quiet Ionian ruins of Teos sit about 4 km away' },
        { cat: 'Nightlife', name: 'İzmir — Bostanlı sunset + Alsancak', note: 'Vapur to the Bostanlı sunset terrace, then bars on Kıbrıs Şehitleri; Bornova for cheap and young' },
        { cat: 'Stay', name: 'Key Hotel (İzmir) / Nahide (Sığacık)', note: 'Key Hotel is a 1950 modernist seafront building; Nahide a stone boutique inside the kale' },
      ] },
    '5-27': { legId: 'izmir', title: 'The crew reunites',
      ...
      picks: [
        { cat: 'Day', name: 'Kemeraltı bazaar + Smyrna Agora', note: 'Historic market lanes and the Roman agora of ancient Smyrna' },
        { cat: 'View', name: 'Tarihi Asansör or Teras 1885', note: 'Sunset drinks over the gulf from the 1907 elevator or a rooftop in Konak' },
        { cat: 'Nightlife', name: 'Alsancak 1453. Sokak + Kordon meyhane', note: 'Bars on 1453. Sokak; rakı-balık with a view at Tek Tek on the Kordon' },
        { cat: 'Plan', name: 'Overnight Sığacık tonight', note: 'After collecting Grant & Brandel, sleep in Sığacık (Teos plus the kaleiçi) so you can catch the Sunday market tomorrow' },
      ] },
    '5-28': { legId: 'islands', title: 'Across to Greece',
      ...
      notes: 'Visa check: US / EU passports just need 6+ months validity. If anyone holds a Turkish passport, the Greek door-visa at Chios was only confirmed through 31 Mar 2026 — re-verify before booking.',
      picks: [
        { cat: 'Market', name: 'Sığacık Pazarı (Sunday)', note: 'Village-producer market through the castle lanes, about 10:00–12:00, then drive to Çeşme — the payoff of last night’s detour', link: 'https://eksisozluk.com/sigacik-pazari--4150783' },
        { cat: 'Beach', name: 'Çeşme swim before the ferry', note: 'Beach clubs (Fly-Inn, Aya Yorgi) are pricey; Ilıca and Altınkum are free. Foça is the cheaper, authentic alternative' },
        { cat: 'Ferry', name: 'Çeşme → Chios', note: 'Ertürk / Turyol catamaran, about €42 and 30 min — book the car crossing ahead; passport valid 6+ months', link: 'https://www.erturk.com.tr/en/cesme-chios-ferry-ticket' },
        { cat: 'Stop', name: 'Alaçatı old town', note: 'Stay and eat in bohemian Hacımemiş (bars Baby Winehouse, Nook); be selective — notoriously pricey' },
      ] },
